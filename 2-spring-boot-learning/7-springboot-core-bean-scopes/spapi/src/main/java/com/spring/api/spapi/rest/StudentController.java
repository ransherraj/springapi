...
public class StudentController {
    ...
    @Autowired
    public StudentController(@Qualifier("boardStudent") Student st,
                             @Qualifier("boardStudent") Student newSt){
    ...
    @Autowired
    public void setStudent(@Qualifier("boardStudent") Student stu){
